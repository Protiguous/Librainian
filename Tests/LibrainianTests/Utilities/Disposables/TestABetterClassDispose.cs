...
//
// File "TestABetterClassDispose.cs" last touched on 2022-01-22 at 1:16 AM by Protiguous.

namespace TestBigDecimal.Utilities.Disposables;
...
public class TestABetterClassDispose {
	...
	public class TestABCD : ABetterClassDispose {
		...
		public TestABCD( Int32 val ) => this._value = val;
		...
		public override void DisposeManaged() {
			if ( this._value % 1024 == 1024 ) {
				TestContext.WriteLine( this._value );
			}
		}
	}
}