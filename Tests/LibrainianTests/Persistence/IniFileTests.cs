...
//
// File "IniFileTests.cs" last touched on 2022-01-22 at 1:16 AM by Protiguous.

namespace TestBigDecimal.Persistence;
...
";
	...
	public static async Task test_save_from_string() {
		...
		if ( saved ) {
			...
			TestContext.WriteLine( temp.FullPath );
		}
		else {
			TestContext.WriteLine( "File not saved." );
		}
	}
