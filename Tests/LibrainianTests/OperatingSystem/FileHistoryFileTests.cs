...
//
// File "FileHistoryFileTests.cs" last touched on 2022-01-22 at 1:18 AM by Protiguous.

namespace TestBigDecimal.OperatingSystem;
...
public static class FolderTests {
	...
	public static void TestCompactFormat() {
		...
		TestContext.WriteLine( example.ToCompactFormat() );
	}
	...
	public static void TestExpandedLevelsDeep() {
		...
		TestContext.WriteLine( example.DoubleQuote() );
		TestContext.WriteLine( example.LevelsDeep() );
