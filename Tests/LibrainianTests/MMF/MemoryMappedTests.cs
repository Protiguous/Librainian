...
//
// File "MemoryMappedTests.cs" last touched on 2022-02-07 at 3:20 AM by Protiguous.

namespace TestBigDecimal.MMF;
...
public class MemoryMappedTests {
	...
	public static String GetContent( MemoryMappedFile memoryMappedFile, Int64 beginningByteLocation, Int64 bytesToReadIn ) {
		...
		var read = memoryMappedViewStream.Read( contentArray, 0, contentArray.Length );
		if ( read is 0 ) {
			return String.Empty;
		}
