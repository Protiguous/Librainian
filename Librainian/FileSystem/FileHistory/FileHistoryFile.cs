...
//
// File "FileHistoryFile.cs" last formatted on 2022-12-22 at 5:15 PM by Protiguous.
...
public class FileHistoryFile {
	...
	public FileHistoryFile( DocumentFile biglongpath ) {
	...
	public IDocumentFile FullPathAndName => new DocumentFile( this.Folder, this.FileName );

	public Boolean IsFileHistoryFile { get; }

	public DocumentFile OriginalPath { get; }
	...
	/// <param name="when">
	///     <para>Returns the <see cref="DateTime" /> part of this <see cref="DocumentFile" /> or null.</para>
	/// </param>
	/// <exception cref="ArgumentEmptyException"></exception>
	public static Boolean TryParseFileHistoryFile( DocumentFile original, out IFolder? folder, out String? filename, out DateTime? when ) {
		if ( original is null ) {
