...
//
// File "MainDocumentTable.cs" last formatted on 2022-12-22 at 5:16 PM by Protiguous.
...
/// <summary>A persisted cache of all found <see cref="DocumentFile" />.</summary>
public static class MainDocumentTable {
	...
	public static PersistTable<String, DocumentFile> Documents { get; } = new( Environment.SpecialFolder.CommonApplicationData,
	...
	public static async Task SearchAsync( IFolder folder, IProgress<IFolder>? folders = null, IProgress<DocumentFile>? reportDocument = null ) {
