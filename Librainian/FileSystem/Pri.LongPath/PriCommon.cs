...
public static class PriCommon {
	...
	private static String GetMessageFromErrorCode( PriNativeMethods.FilesAndFoldersErrors filesAndFoldersErrorsCode ) {
		...
		_ = PriNativeMethods.FormatMessage(
	...
	public static FileAttributes GetAttributes( this String path ) {
		...
		if ( errorCode != ( Int32 )PriNativeMethods.FilesAndFoldersErrors.ERROR_SUCCESS ) {
			throw PriCommon.GetExceptionFromWin32Error( errorCode );
		}
	...
	public static Exception GetExceptionFromLastWin32Error() => PriCommon.GetExceptionFromLastWin32Error( "path" );

	public static Exception GetExceptionFromLastWin32Error( String parameterName ) =>
		PriCommon.GetExceptionFromWin32Error( ( PriNativeMethods.FilesAndFoldersErrors )Marshal.GetLastWin32Error(), parameterName );

	public static Exception GetExceptionFromWin32Error( PriNativeMethods.FilesAndFoldersErrors filesAndFoldersErrorsCode ) =>
		PriCommon.GetExceptionFromWin32Error( filesAndFoldersErrorsCode, "path" );
	...
	public static Exception GetExceptionFromWin32Error( PriNativeMethods.FilesAndFoldersErrors filesAndFoldersErrorsCode, String parameterName ) {
		var message = PriCommon.GetMessageFromErrorCode( filesAndFoldersErrorsCode );
		...
		return filesAndFoldersErrorsCode switch {
			...
			PriNativeMethods.FilesAndFoldersErrors.ERROR_SUCCESS => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_ALREADY_EXISTS => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_BAD_NETPATH => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_BAD_PATHNAME => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_CANT_OPEN_ANONYMOUS => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_DIRECTORY => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_FILE_EXISTS => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_INVALID_HANDLE => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_INVALID_OWNER => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_INVALID_PARAMETER => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_INVALID_PRIMARY_GROUP => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_LOGON_FAILURE => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_NETNAME_DELETED => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_NO_MORE_FILES => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_NO_SECURITY_ON_OBJECT => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_NO_SUCH_PRIVILEGE => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_NO_TOKEN => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_NOT_ALL_ASSIGNED => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_NOT_ENOUGH_MEMORY => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_NOT_READY => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_PRIVILEGE_NOT_HELD => throw new NotImplementedException(),
			PriNativeMethods.FilesAndFoldersErrors.ERROR_SHARING_VIOLATION => throw new NotImplementedException(),
	...
	public static FileAttributes GetFileAttributes( this String path ) {
		...
		var errorCode = PriCommon.TryGetFileAttributes( normalizedPath, out var fileAttributes );
	...
	public static void SetAttributes( this String path, FileAttributes fileAttributes ) {
		...
		if ( !PriNativeMethods.SetFileAttributes( normalizedPath, fileAttributes ) ) {
			throw PriCommon.GetExceptionFromLastWin32Error();
		}
	}
    ...
    */
	...
	public static PriNativeMethods.FilesAndFoldersErrors TryGetDirectoryAttributes( this String normalizedPath, out FileAttributes attributes ) =>
		PriCommon.TryGetFileAttributes( normalizedPath.ThrowIfBlank(), out attributes );
