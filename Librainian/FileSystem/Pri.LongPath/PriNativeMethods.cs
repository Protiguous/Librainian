...
public static class PriNativeMethods {
	...
	[DllImport( DLL.CoreDLL, BestFitMapping = false, SetLastError = true, CharSet = CharSet.Unicode )]
	[return: MarshalAs( UnmanagedType.Bool )]
	...
	[DllImport( DLL.Advapi32, BestFitMapping = false, SetLastError = true, CharSet = CharSet.Unicode )]
    ...
    */
	...
	[DllImport( DLL.Kernel32, BestFitMapping = false, CharSet = CharSet.Unicode, ExactSpelling = false, SetLastError = true )]
    ...
    */
	...
	public static String GetMessage( FilesAndFoldersErrors filesAndFoldersErrorsCode ) {
	...
	[DllImport( DLL.Advapi32, BestFitMapping = false, EntryPoint = "LookupPrivilegeValueW", CharSet = CharSet.Unicode, SetLastError = true )]
    ...
    */
	...
	public static void XCopy( this String oldFile, String newFile, CopyProgressRoutine? progress, ref Int32 isCancelled ) {
