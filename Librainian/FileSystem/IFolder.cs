...
//
// File "IFolder.cs" last formatted on 2022-12-22 at 5:16 PM by Protiguous.
...
public interface IFolder : IEquatable<IFolder> {
	...
	IAsyncEnumerable<DocumentFile> EnumerateDocuments( IEnumerable<String> searchPatterns, CancellationToken cancellationToken );

	IAsyncEnumerable<DocumentFile> EnumerateDocuments( String? searchPattern, CancellationToken cancellationToken );
	...
	/// <summary>
	///     <para>Check if this <see cref="IFolder" /> contains any <see cref="IFolder" /> or <see cref="DocumentFile" /> .</para>
	/// </summary>
	/// <param name="cancellationToken"></param>
