...
//
// File "DocumentCopyStatistics.cs" last formatted on 2022-03-10 at 4:58 AM by Protiguous.
...
public record DocumentCopyStatistics {
	...
	[JsonProperty]
	public IDocumentFile? DestinationDocument { get; set; }

	[JsonProperty]
	public String? DestinationDocumentCRC64 { get; set; }

	[JsonProperty]
	public IDocumentFile? SourceDocument { get; set; }
