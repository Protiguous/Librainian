...
//
// File "Startup.cs" last formatted on 2022-02-16 at 3:37 PM by Protiguous.
...
public static class Startup {
	...
	public static IServiceCollection InjectLibrainianServices( this IServiceCollection services ) {
		...
		services.AddSingleton<ISecretRevealer, SecretRevealer>();
		services.AddScoped<ICircularLinesLogger, CircularLinesLogger>();
		services.AddSingleton<IApplicationSetting, ApplicationSetting>();
		services.AddTransient<IValidatedConnectionString, ValidatedConnectionString>();
		services.AddTransient<IDatabaseServer, DatabaseServer>();
