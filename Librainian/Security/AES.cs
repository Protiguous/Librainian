...
//
// File "AES.cs" last formatted on 2022-02-22 at 7:29 AM by Protiguous.
...
public class AES {
	...
	public UInt32 Decrypt( Int32 pcbCipherText, Byte[]? pbCipherText ) {
		...
		_ = BCryptDecrypt( this._keyHandle, pbCipherText, pcbCipherText, IntPtr.Zero, pbIV2, pbIV2.Length, null, 0, ref pcbPlainText, 0 );
	...
	public UInt32 Encrypt( Byte[] pbData ) {
		...
		_ = BCryptEncrypt( this._keyHandle, pbData, pbData.Length, IntPtr.Zero, pbIV, pbIV.Length, null, 0, ref pcbCipherText, 0 );
	...
	public UInt32 Open() {
		...
		//Initialize Status
		_ = BCryptOpenAlgorithmProvider( ref this._algHandle, "AES", "Microsoft Primitive Provider", 0 );
		...
		_ = BCryptGetProperty( this._algHandle, "ObjectLength", pbObjectLength, pbObjectLength.Length, ref pcbObjectLength, 0 );
