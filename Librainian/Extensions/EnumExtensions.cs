...
//
// File "EnumExtensions.cs" last formatted on 2022-12-22 at 5:15 PM by Protiguous.
...
/// <summary>Some extensions pulled from <see cref="http://stackoverflow.com/a/944352/956364" /></summary>
public static class EnumExtensions {


	/// <summary>Returns the text of the [Description("text")] attribute on an enum. Or null if not found.</summary>
	/// <param name="element"></param>
	public static String? Description<T>( this T element ) where T : Enum {
	...
	/// TODO How to check if enum value has the [Flag] attribute?
	/// <param name="value"></param>
	public static IEnumerable<T> GetAllSelectedItems<T>( this T value!! ) where T : Enum  => Enum.GetValues( typeof( T ) ).Cast<T>().Where( item => value.HasFlag( item ) );

	/// <summary>Gets all values from any enum <paramref name="value"/> value.</summary>
	/// <typeparam name="T"></typeparam>
	/// <param name="value">The value.</param>
	/// <exception cref="ArgumentEmptyException"><paramref name="value"/></exception>
	public static IEnumerable<T> GetAllValues<T>( this T value!! ) where T : Enum => Enum.GetValues( value.GetType() ).Cast<T>();
