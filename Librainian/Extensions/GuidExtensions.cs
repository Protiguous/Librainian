...
//
// File "GuidExtensions.cs" last formatted on 2022-02-22 at 8:30 AM by Protiguous.
...
public static class GuidExtensions {
	...
	public static readonly Regex InGuidFormat =
		new(
			...
			"^({)?[0xA-Fa-f0-9]{3,10}(, {0,1}[0xA-Fa-f0-9]{3,6}){2}, {0,1}({)([0xA-Fa-f0-9]{3,4}, {0,1}){7}[0xA-Fa-f0-9]{3,4}(}})$", RegexOptions.Compiled, Seconds.One );
