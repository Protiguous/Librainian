...
//
// File "I.cs" last formatted on 2022-12-22 at 5:20 PM by Protiguous.
...
public class I {
	...
	public I( String key, Uri address ) {
	...
	public I( String key, String? address ) {
		this.K = key ?? throw new ArgumentEmptyException( nameof( key ) );
