...
//
// File "JSONFile.cs" last formatted on 2022-02-10 at 8:06 AM by Protiguous.
...
public class JSONFile {
	...
	public JSONFile( DocumentFile? document, CancellationToken cancellationToken ) : this() {
	...
	public ReadOnlyDataType? this[String? section] {
		...
		get {
			...
			if ( this.Data.ContainsKey( section ) && this.Data.TryGetValue( section, out var result ) ) {
				return result;
			}
