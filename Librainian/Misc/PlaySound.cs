...
// 
// File "PlaySound.cs" last formatted on 2022-02-17 at 11:22 AM by Protiguous.
...
public class PlaySound {
    ...
    public static Int32 GetSoundLength( String fileName ) {
        ...
        NativeMethods.mciSendString( $"open {fileName.DoubleQuote()} type waveaudio alias wave", null, 0, IntPtr.Zero );
        ...
        _ = Int32.TryParse( lengthBuf.ToString(), out var length );
    ...
    public async Task Start( String fileName ) {
        ...
        await Task.Delay( GetSoundLength( fileName ) ).ConfigureAwait( false );
        this.Stop();
    }
