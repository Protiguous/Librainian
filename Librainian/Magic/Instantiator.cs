...
public static class Instantiator<T> {
	...
	[return: NotNull]
	public static T New<TA, TB, TC>( TA? valueA, TB? valueB, TC? valueC ) => InstantiatorImpl<TA, TB, TC>.CtorFunc( valueA, valueB, valueC );
	...
	[return: NotNull]
	public static T New<TA, TB, TC, TD>( TA? valueA, TB? valueB, TC? valueC, TD? valueD ) => InstantiatorImpl<TA, TB, TC, TD>.CtorFunc( valueA, valueB, valueC, valueD );
