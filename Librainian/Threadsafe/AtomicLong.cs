...
//
// File "AtomicLong.cs" last formatted on 2022-02-06 at 6:45 AM by Protiguous.
...
public struct AtomicLong {
	...
	/// <summary>Create a new <see cref="AtomicLong" /> with the given initial value.</summary>
	/// <param name="value">Initial value</param>
	public AtomicLong( Int64 value ) => this._value = value;
