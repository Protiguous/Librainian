...
//
// File "ReferenceArray.cs" last formatted on 2022-12-22 at 5:21 PM by Protiguous.
...
public class ReferenceArray<T> where T : class {
	...
	public Boolean AtomicCompareExchange( Int32 index, T? newValue, T? comparand ) => Interlocked.CompareExchange( ref this.Array[ index ], newValue, comparand ) == comparand;
