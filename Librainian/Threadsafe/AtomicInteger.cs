...
//
// File "AtomicInteger.cs" last formatted on 2022-02-08 at 6:04 AM by Protiguous.
...
public struct AtomicInteger {
	...
	/// <summary>Create a new <see cref="AtomicInteger" /> with the given initial value.</summary>
	/// <param name="value">Initial value</param>
	public AtomicInteger( Int32 value ) => this._value = value;
