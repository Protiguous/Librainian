...
public static class GraphicsExtensions {
	...
	public static Task<Erg> TryConvertToERG( this DocumentFile documentFile, CancellationToken cancellationToken ) {
	...
	public static Task<Boolean> TrySave( this Erg erg, DocumentFile documentFile, CancellationToken cancellationToken ) {
		if ( erg == null ) {
	...
	public static Task<Boolean> TrySave( this Efv efv, DocumentFile documentFile, CancellationToken cancellationToken ) {
		if ( efv == null ) {
