...
//
// File "MemMapCache.cs" last formatted on 2022-12-22 at 5:15 PM by Protiguous.
...
public class MemMapCache<T> : ABetterClassDispose {
	...
	public T? Get( String key ) {
		...
		try {
			if ( this._keyExpirations.ContainsKey( key ) && ( DateTime.UtcNow >= this._keyExpirations[key] ) ) {
