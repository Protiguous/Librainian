...
//
// File "ObjectExtensions.cs" last formatted on 2022-02-08 at 6:02 AM by Protiguous.
...
public static class ObjectExtensions {
	...
	[NeedsTesting]
	private static void RecursiveCopyBaseTypePrivateFields( Object? originalObject, IDictionary<Object, Object?> visited, Object? destination, Type typeToReflect ) {
		if ( originalObject is null ) {
			return;
		}
	...
	[NeedsTesting]
	public static T? Copy<T>( this T? original ) => ( T? )( DeepCopy( original ) ?? throw new NullReferenceException( nameof( original ) ) );
