...
public static class Bits {
	...
	public static Byte[] GetBytes( this UInt256 value, ref Byte[] destination ) {
        value.ToByteArray( destination, 0 );
    ...
    public static UInt256 ToUInt256( this Byte[] value!! ) => new( value );
