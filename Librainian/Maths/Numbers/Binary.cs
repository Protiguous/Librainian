...
//
// File "Binary.cs" last formatted on 2022-02-06 at 5:39 AM by Protiguous.
...
public class Binary : IEnumerable<Boolean> {
	...
	public static IEnumerable<Boolean> ConvertToBoolean( Int32 value ) => Convert.ToString( value, 2 ).Select( c => c == '1' );
