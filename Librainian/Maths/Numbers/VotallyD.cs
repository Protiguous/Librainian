...
//
// File "VotallyD.cs" last formatted on 2022-02-16 at 2:25 PM by Protiguous.
...
public record VotallyD {
	...
	public static VotallyD Combine( in VotallyD left, in VotallyD right ) {
		if ( left is null ) {
