...
//
// File "PotentialF.cs" last formatted on 2022-12-22 at 4:22 AM by Protiguous.
...
public class PotentialF {
	...
	/// <summary>
	///     Sets the internal value to a random number between <paramref name="min" /> and <paramref name="max" />, and between
	///     0 and 1.
	/// </summary>
