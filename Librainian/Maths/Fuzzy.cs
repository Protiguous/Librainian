...
//
// File "Fuzzy.cs" last formatted on 2022-02-16 at 9:39 AM by Protiguous.
...
[JsonObject]
public class Fuzzy : ICloneable<Fuzzy> {
	...
	public Double Value {
		...
		set =>
			this._value.Value = value switch {
				> MaxValue => MaxValue,
				< MinValue => MinValue,
				var _ => value
			};
	...
	public Fuzzy Clone() => new( this.Value );
