...
/// <summary><para>Logs exception when the (string) parameter is null, empty, or whitespace.</para>
/// <para>If attached to a debugger, <see cref="System.Diagnostics.Debugger.Break"/> is called.</para>
/// </summary>
[Serializable]
public class ArgumentEmptyException : ArgumentNullException {
	...
	public ArgumentEmptyException( String? paramName ) {
		CannotBeEmpty( paramName ).DebugWriteLine();
