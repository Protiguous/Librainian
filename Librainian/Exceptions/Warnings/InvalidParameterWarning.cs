...
//
// File "InvalidParameterWarning.cs" last formatted on 2022-12-22 at 5:15 PM by Protiguous.
...
public class InvalidParameterWarning : Warning {
	...
	public InvalidParameterWarning( String message ) : base( message ) => message.Break();

	public InvalidParameterWarning( String message, Exception? inner ) : base( message, inner ) => message.Break();
}