...
//
// File "Warning.cs" last formatted on 2022-02-06 at 5:45 AM by Protiguous.
...
public class UnknownWarning : Warning {
	...
	protected UnknownWarning() {
	}

	protected UnknownWarning( String? message, Exception? inner ) : base( message, inner ) {
	}

	public UnknownWarning( String? message ) : base( message ) => message.Break();
}
