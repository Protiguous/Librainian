...
//
// File "Dice.cs" last formatted on 2022-12-22 at 5:16 PM by Protiguous.
...
public record Dice : AbstractGameObject {
	private UInt16 _currentSide;

	/// <summary>A 6-sided dice.</summary>
	public static readonly Dice Cube = new( Guid.NewGuid(), 6 );
