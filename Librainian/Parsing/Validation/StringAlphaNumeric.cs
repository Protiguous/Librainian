...
//
// File "StringAlphaNumeric.cs" last formatted on 2022-12-22 at 5:18 PM by Protiguous.
...
public class StringAlphaNumeric : RegexString {
	...
	public StringAlphaNumeric( String value ) : base( value, "^[a-zA-Z0-9]*$", Seconds.One ) {
	}
