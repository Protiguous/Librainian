...
//
// File "StringHexPrefix.cs" last formatted on 2022-02-17 at 11:59 AM by Protiguous.
...
public class StringHexPrefix : RegexString {
	...
	public StringHexPrefix( String value ) : base( value, "^(0x|&H)?[0-9a-fA-F]*$", Seconds.One ) {
	}

	public static explicit operator StringHexPrefix( String value ) => new( value );
}