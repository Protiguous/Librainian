...
//
// File "CompositeFormatter.cs" last formatted on 2022-12-22 at 5:18 PM by Protiguous.
...
internal sealed class CompositeFormatter : Formatter {
	...
	public CompositeFormatter( CultureInfo? culture = null, params Formatter[] formatters ) : base( culture ) => this._formatters = new List<Formatter>( formatters );
	...
	/// <exception cref="ArgumentEmptyException"><paramref name="formatter"/></exception>
