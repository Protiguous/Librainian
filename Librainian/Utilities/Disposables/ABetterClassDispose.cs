...
public abstract class ABetterClassDispose : IABetterClassDispose {
	...
	//protected ABetterClassDispose() { /*this.SetDisposeHint( hint ); }
	...
	/// <summary>Just calls <see cref="Dispose()" />. The parameter <paramref name="dispose" /> has no effect with this design.</summary>
