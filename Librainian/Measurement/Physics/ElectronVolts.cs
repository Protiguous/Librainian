...
//
// File "ElectronVolts.cs" last formatted on 2022-12-22 at 5:17 PM by Protiguous.
...
[Immutable]
public readonly record struct ElectronVolts( BigDecimal Value ) : IComparable<MilliElectronVolts>, IComparable<ElectronVolts>, IComparable<MegaElectronVolts>, IComparable<GigaElectronVolts> {
	/// <summary>
	...
	public static ElectronVolts operator *( ElectronVolts left, BigDecimal right ) => new( left.Value * right );
	public static ElectronVolts operator *( ElectronVolts left, Decimal right ) => new( left.Value * ( BigDecimal )right );

	public static ElectronVolts operator *( Double left, ElectronVolts right ) => new( ( BigDecimal )left * right.Value );
	public static ElectronVolts operator *( Decimal left, ElectronVolts right ) => new( ( BigDecimal )left * right.Value );
	...
	[SuppressMessage( "Major Bug", "S3903:Types should be defined in named namespaces", Justification = "Not a bug, da." )]
	public static class InOne {
		public static readonly BigDecimal ElectronVolt = ( BigDecimal )1E0m;

		public static readonly BigDecimal GigaElectronVolt = ( BigDecimal )1E9m;

		public static readonly BigDecimal KiloElectronVolt = ( BigDecimal )1E3m;

		public static readonly BigDecimal MegaElectronVolt = ( BigDecimal )1E6m;

		public static readonly BigDecimal MilliElectronVolt = ( BigDecimal )1E-3m;

		public static readonly BigDecimal TeraElectronVolt = ( BigDecimal )1E12m;
	}
