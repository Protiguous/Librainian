...
//
// File "Feet.cs" last formatted on 2022-12-22 at 6:14 AM by Protiguous.
...
public record Feet( BigDecimal Value ) : IQuantityOfDistance, IComparable<Feet> {
	...
	public Int32 CompareTo( Feet? other ) =>
		other is null ? SortingOrder.After :
		ReferenceEquals( this, other ) ? SortingOrder.Same : this.Value.CompareTo( other.Value );
	...
	public static Boolean operator <=( Feet left, Feet right ) => left.CompareTo( right ) <= 0;
