...
//
// File "Hours.cs" last formatted on 2022-12-22 at 5:18 PM by Protiguous.
...
public record Hours( BigDecimal Value ) : IQuantityOfTime, IComparable<Hours> {
	...
	public override String ToString() => $"{this.Value} {this.Value.SingleOrPluralOf( "hour" )}";

	public static Boolean operator <=( Hours left, Hours right ) => left.CompareTo( right ) <= 0;
