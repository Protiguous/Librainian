...
//
// File "DateSpan.cs" last formatted on 2022-02-06 at 5:42 AM by Protiguous.
...
public struct DateSpan {
	...
	public DateSpan( DateTime start, DateTime end, Boolean excludeEndDate = true ) : this() => this.Initialize( start, end, excludeEndDate );
	...
	/// <param name="end">The end date</param>
	/// <param name="excludeEndDate">If true, the span is exclusive of the end date</param>
	public DateSpan( DateTimeOffset start, DateTimeOffset end, Boolean excludeEndDate = true ) : this() => this.Initialize( start.DateTime, end.DateTime, excludeEndDate );
