...
//
// File "Weeks.cs" last formatted on 2022-12-22 at 6:14 AM by Protiguous.
...
public record Weeks( BigDecimal Value ) : IQuantityOfTime, IComparable<Weeks>, IComparable<IQuantityOfTime> {
	...
	public override String ToString() => $"{this.Value} {this.Value.SingleOrPluralOf( "week" )}";

	public static Boolean operator <=( Weeks left, Weeks right ) => left.CompareTo( right ) <= 0;
