...
//
// File "Months.cs" last formatted on 2022-12-22 at 5:18 PM by Protiguous.
...
public record Months( BigDecimal Value ) : IQuantityOfTime, IComparable<Months> {
	...
	/// <summary>Return this value in <see cref="Weeks" />.</summary>
	...
	/// <summary>Return this value in <see cref="Years" />.</summary>
	...
	public static Boolean operator <=( Months left, Months right ) => left.CompareTo( right ) <= 0;
