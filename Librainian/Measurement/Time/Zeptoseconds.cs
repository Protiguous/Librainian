...
//
// File "Zeptoseconds.cs" last formatted on 2022-12-22 at 6:14 AM by Protiguous.
...
public record Zeptoseconds( BigDecimal Value ) : IQuantityOfTime, IComparable<Zeptoseconds> {
	...
	public static Boolean operator <=( Zeptoseconds left, Zeptoseconds right ) => left.CompareTo( right ) <= 0;
