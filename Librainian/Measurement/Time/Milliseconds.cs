...
//
// File "Milliseconds.cs" last formatted on 2022-12-22 at 5:18 PM by Protiguous.
...
public record Milliseconds( BigDecimal Value ) : IQuantityOfTime, IComparable<Milliseconds> {
	...
	public override String ToString() => $"{this.Value} {this.Value.SingleOrPluralOf( "millisecond" )}";

	public static Boolean operator <=( Milliseconds left, Milliseconds right ) => left.CompareTo( right ) <= 0;
