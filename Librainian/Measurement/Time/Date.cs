...
//
// File "Date.cs" last formatted on 2022-12-22 at 5:17 PM by Protiguous.
...
/// <summary><see cref="Years" />, <see cref="Months" />, and <see cref="Days" />.</summary>
...
public record Date( Years Years, Months Months, Days Days ) {
	...
	public static implicit operator DateTime?( Date date ) => DateTimeExtensions.TryConvertToDateTime( date, out var dateTime ) ? dateTime : default( DateTime? );
	...
	public Boolean TryConvertToDateTime( out DateTime? dateTime ) => DateTimeExtensions.TryConvertToDateTime( this, out dateTime );
}