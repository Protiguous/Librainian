...
//
// File "Hertz.cs" last formatted on 2022-12-22 at 7:19 AM by Protiguous.
...
public record Hertz {
	public Hertz( Decimal frequency ) => this.Value = frequency <= 0m.Epsilon() ? 0m.Epsilon() : frequency >= Decimal.MaxValue ? Decimal.MaxValue : frequency;
